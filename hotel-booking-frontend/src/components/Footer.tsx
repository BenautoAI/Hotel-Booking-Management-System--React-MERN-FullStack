    ...
    <footer className="bg-gradient-to-r from-primary-800 to-primary-900 text-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Support */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-red-500">Support</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-red-500">support@mernholidays.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-red-500" />
                <span className="text-red-500">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
